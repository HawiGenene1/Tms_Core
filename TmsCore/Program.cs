...
// TODO 5: Calculate the average GPA
decimal averageGpa = students.Average(s => s.GPA);

Console.WriteLine($"\nClass Average GPA: {averageGpa:F2}");

// TODO 6: Group students by academic standing
...
// TODO 7: Merge arrays using the spread operator
...
{
    Console.WriteLine($" {loadedStudent.Name} GPA: {loadedStudent.GPA}");
}
